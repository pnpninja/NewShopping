...
orig_data = pd.read_csv(
    "music_data.csv",
    usecols=["userId", "artistId", "artist", "plays"],
    encoding="unicode_escape",
)
data = pd.read_csv(
    "music_data.csv", usecols=["userId", "artistId", "plays"], encoding="unicode_escape"
)
...
rec = tc.recommender.item_similarity_recommender.create(
...
for a in artists:
    artistId_to_artistName[a] = orig_data.loc[
        orig_data["artistId"] == a, "artist"
    ].unique()[0]
